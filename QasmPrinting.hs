...
qqmap = Map.fromList [
  ...
  (("Y", 1, 0, False, []), ("y", "")),  
  (("Y", 1, 0, False, [Signed Qbit True]), ("cy", "")),
  (("Z", 1, 0, False, []), ("z", "")),
  (("Z", 1, 0, False, [Signed Qbit True]), ("cz", "")),
  (("Z", 1, 0, False, [Signed Qbit True, Signed Qbit True]), ("ccz", "")),
  (("Y", 1, 0, True, []), ("y", "")),  
  (("Y", 1, 0, True, [Signed Qbit True]), ("cy", "")),
  (("Z", 1, 0, True, []), ("z", "")),
  (("Z", 1, 0, True, [Signed Qbit True]), ("cz", "")),
  (("Z", 1, 0, True, [Signed Qbit True, Signed Qbit True]), ("ccz", "")),
  (("S", 1, 0, False, []), ("s", "")),
  (("S", 1, 0, True, []), ("sdg", "")),
  (("T", 1, 0, False, []), ("t", "")),
  (("T", 1, 0, True, []), ("tdg", "")),
